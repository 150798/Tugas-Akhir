...
public class ApiVolley {
    ...
    public ApiVolley(final Context context, JSONObject jsonBody, String requestMethod,
                     String REST_URL, final VolleyCallback callback){
        ...
        try {
            HttpsURLConnection.setDefaultHostnameVerifier(new HostnameVerifier(){
                public boolean verify(String hostname, SSLSession session) {
                    if (hostname.equalsIgnoreCase("tugasakhir-ba915.firebaseio.com") ||

                            hostname.equalsIgnoreCase("smartoffice16.000webhostapp.com") ||
